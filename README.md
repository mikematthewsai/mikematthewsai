...
**Build logs** on [matthewsautomation.net/blog](https://matthewsautomation.net/blog): what broke, why, and how it was fixed, written as it happened. Most recent: [four SMS workflows that do not need a database](https://matthewsautomation.net/blog/build-log-four-sms-templates-no-database) and [the appointment reminder that would have arrived after the appointment](https://matthewsautomation.net/blog/build-log-appointment-reminders-quiet-hours).
